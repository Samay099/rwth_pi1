...
void ausgeliehenenMedienausgeben(std::vector<Medium*>& medien);
...
int main()
{
    ...
    do  // Anzeige des Men�s
    {
        ...
        switch (abfrage)
        {
            ...
            ////////////////////////////////////////////////////////
            // Ausgabe alle ausgeliehenen Medien in der Datenbank //
            ////////////////////////////////////////////////////////
            case '6':
            {
                ausgeliehenenMedienausgeben(medien);
                break;
            }
...
void ausgeliehenenMedienausgeben(std::vector<Medium*>& medien)
{
    std::cout << "Ausgeliehenen Medien in der B�cherei:" << std::endl;

    unsigned int index = 0;

    for ( index = 0; index < medien.size(); index++)
    {
