...
std::vector<Student> studentSort(std::vector<Student>& studentVector)
{
        ...
        switch (abfrage)
        {
            ...
            case '5':
                if(!studentenVector.empty())
                {
                    ...
                    Student searchStudent(matrikelnummer,"","","");

                    std::vector<Student>::iterator it;

                    it = find(studentenVector.begin(), studentenVector.end(), searchStudent);
            ...
            case '9':
                if(!studentenVector.empty())
                {
                    studentenVector = studentSort(studentenVector);
